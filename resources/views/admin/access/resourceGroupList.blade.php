...
<body>
    <div style="padding:0 10px;">
        <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="">资源组管理</a></li>
        </ul>
        <br> 
            ...
            @foreach ($action_group_list as $k => $v)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-info" href="/cp/longrentdepartment/resourcegroupdetail?id={{$v['id']}}">资源编辑</a>
                    </td>
                </tr>
            @endforeach
        </table>
    </div>
<div id="add-box" style="display:none; position: absolute; top: 40%; left:25%; padding: 2px;width: 500px; border: 8px solid #E8E9F7; background-color: white; z-index:1002; overflow: auto;">
...
<script type="text/javascript">
    $(function(){
        $('#new-group').click(function(){
            ...
            $("#add-box").css('left', $(this).offset().left);
